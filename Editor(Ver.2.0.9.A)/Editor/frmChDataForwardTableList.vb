...
#Region "画面イベント"
    ...
    Private Sub frmChDataForwardTableList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Else
                Call mSetDisplay(gudt2.SetChDataForward)
            End If
...
#Region "グリッドイベント"
    ...
    '--------------------------------------------------------------------
    Private Function mCheckInputLengthNum(ByVal objGridText As Object,
    ...
    '--------------------------------------------------------------------
    Private Function mCheckInputLengthValue(ByVal objGridText As Object,
                                            ByVal evt As System.Windows.Forms.KeyPressEventArgs) As Boolean
    ...
    ' 機能説明  : 入力文字数をチェックする
    '--------------------------------------------------------------------
    Private Function mCheckInputLengthValueLimit(ByVal hintMaxLength As Integer,
...
#Region "内部関数"
    ...
    Private Function mChkInput() As Boolean
        ...
        Try
            ...
            For i = 0 To grdData.RowCount - 1
                ...
                If strCode = gCstCodeChDataForwardCodeNone.ToString And
                   strSubCode = "0" And
                   strOffsetToFCU = "0" And
                   strSizeToFCU = "0" And
                   strOffsetToOPS = "0" And
                   strSizeToOPS = "0" Then
    ...
    '--------------------------------------------------------------------
    Private Sub mCopyStructure(ByVal udtSource As gTypSetChDataForward,
    ...
    '--------------------------------------------------------------------
    Private Function mChkStructureEquals(ByVal udt1 As gTypSetChDataForward,
